...
<center><h2>Vase aktuelne rezervacije</h2></center>
    <table align="center">
        <tr align="center">
            <center><td>USERNAME</td></center>
            <center><td>BIOSKOP</td></center>
           <center><td>ID SALE</td></center>
            <center><td>UKUPNO ZA PLACANJE</td></center>
        </tr>
...
%>
    <tr>
        <td><input type="text" value="<%=resultSet.getString("name") %>" readonly></td>
        <td><input type="text" value="<%=resultSet.getString("cinemanema") %>" readonly></td>
        <td><input type="text" value="<%=resultSet.getString("naziv") %>" readonly></td>
        <td><input type="text" value="<%=resultSet.getString("price") %>" readonly></td>
    </tr>
