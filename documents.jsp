            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_trip">
                        ...
                        <div class="info">
                            <div class="date">
                                <span>Avg 02, 2018</span>
                            </div>
                            <a href="allusers.jsp">
                                <h3>Editovanje podataka korisnika</h3>
                            </a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="single_trip">
                        ...
                        <div class="info">
                            <div class="date">
                                <span>Jan 32, 2020</span>
                            </div>
                            <a href="pravaprivatnosti.jsp">
                                <h3>Sigurnosna licenca</h3>
                            </a>
                        </div>
                    </div>
                </div>
