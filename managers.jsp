...
<body>
    ...
    <!-- header-end -->
    <img src="img/banner/testmonial.png"><br><br>
    <table align="center">
        <tr align="center">
            <td>IME </td>
            <td>EMAIL </td>
...
<tr>
   ...
   <td><input type="text" value="<%=resultSet.getString("email")%>"readonly></td>
   <td><input type="text" value="<%=resultSet.getString("password")%>"readonly></td>
   <td><input type="text" value="<%=resultSet.getString("role")%>"readonly></td>
</tr>
<% 
}
