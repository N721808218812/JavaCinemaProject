...
<body>
    ...
    <!-- header-end -->
    <form action="Uspesno.jsp" method="post">
        <br><br>
        <center><h3>Izaberite folder</h3></center><br><br>
        <center><input type = "file" name = "file" size = "50" /></center>
         <br />
         <center><input type = "submit" value = "Upload File" /></center><br><br>
</form>
    <footer class="footer">
