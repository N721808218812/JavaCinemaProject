...
<body>
    ...
    <!-- header-end -->
<center><img src="images/edit.png" ></center><br><br>
    <table align="center">
        <tr align="center" style="background-color: #1EC6B6">
            <td>ID</td>
            <td>IME </td>
            <td>EMAIL </td>
            <td>PASSWORD</td>
...
%>
<tr align="center">
  <td><center><input type="text" name="id" value="<%=resultSet.getString("id")%>"readonly></center></td>
  <td><center><input type="text" value="<%=resultSet.getString("name")%>"readonly></center></td>
  <td><center><input type="text" value="<%=resultSet.getString("email")%>"readonly></center></td>
  <td><center><input type="text" value="<%=resultSet.getString("password")%>"readonly></center></td>
  <td><center><input type="text" value="<%=resultSet.getString("role")%>"readonly></center></td>
  <td><center><input type="text" value="<%=resultSet.getString("club")%>"readonly></center></td>
  <td><center><input type="submit" value="OBRISI KORISNIKA" readonly></center></td>
</tr>
<% 
}
