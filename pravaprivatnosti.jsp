...
<body>
    ...
    <!-- header-end -->
<center><h1>Politika privatnosti</h1></center><br><br>
    <center><p>         Veb-sajtom homepage.rs (iskljucujuci povezane sajtove) upravlja se sa <br> adrese Sajkaska 37, 21000 Novi Sad Srbija, a takodje smo i rukovalac <br>Podacima o licnosti koji se odnose na vas, a koje prikupljamo i obradjujemo <br>na ovom veb-sajtu u skladu sa ovom Politikom privatnosti...<a href="https://homepage.rs/uslove-koriscenja-i-politika-privatnosti/">(click to read more)</a><p></center><br><br>
<br.<br>
    <footer class="footer">
