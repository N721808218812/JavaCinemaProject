...
<body>
   ...
   <%
       String yt=request.getParameter("youtube");  
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="video_wrap text-center">
                        <h3>Watch Video For <%=name1%></h3>
                        <div class="video_icon">
                            <a class="popup-video video_play_button" href="https://www.youtube.com/watch?v=<%=yt%>">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8 col-md-9">
                    <div class="destination_info">
                        ...
                        <div class="single_destination">
                            <h4>WATCH Trailer</h4>
                            <p><a href="https://www.youtube.com/watch?v=<%=youtube%>">Youtube - <%=name%> Offical Trailer(Click here)</a></p>
                        </div>
                        <div class="single_destination">
                            <h4>Glumci</h4>
                            <p><%=stars%></p>
                        ...
                        <div class="single_destination">
                            <h4>IMDB</h4>
                            <p><a href="https://www.imdb.com/title/<%=imdb%>">IMDB - <%=name%> (Click here)</a></p>
                        </div>
                    </div>
                </div>
            </div>
